...
This generated skill is the Codex-native plugin surface for `/comfyui:nodes`.
Also use it when the user invokes `/nodes` or asks for the same workflow by name.

Source command: `../../commands/nodes.md`
...
- Plugin: `comfyui`
- Command aliases: `/comfyui:nodes`, `/nodes`
- Source description: Search available ComfyUI node types and show their input/output schemas
