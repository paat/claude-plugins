...
This generated skill is the Codex-native plugin surface for `/comfyui:status`.
...
- Plugin: `comfyui`
- Command aliases: `/comfyui:status`, `/status`
- Source description: Check ComfyUI server health - GPU stats, VRAM usage, queue depth, and connectivity
