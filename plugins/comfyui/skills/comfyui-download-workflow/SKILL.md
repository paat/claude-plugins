...
This generated skill is the Codex-native plugin surface for `/comfyui:download`.
Also use it when the user invokes `/download` or asks for the same workflow by name.

Source command: `../../commands/download.md`
...
- Plugin: `comfyui`
- Command aliases: `/comfyui:download`, `/download`
- Source description: Download a model to ComfyUI via Manager API or direct URL
