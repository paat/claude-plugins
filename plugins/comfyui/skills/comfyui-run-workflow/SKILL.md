...
This generated skill is the Codex-native plugin surface for `/comfyui:run`.
Also use it when the user invokes `/run` or asks for the same workflow by name.

Source command: `../../commands/run.md`
...
- Plugin: `comfyui`
- Command aliases: `/comfyui:run`, `/run`
- Source description: Queue a ComfyUI workflow for execution, monitor progress, and return results
