...
This generated skill is the Codex-native plugin surface for `/comfyui:models`.
Also use it when the user invokes `/models` or asks for the same workflow by name.

Source command: `../../commands/models.md`
...
- Plugin: `comfyui`
- Command aliases: `/comfyui:models`, `/models`
- Source description: List available models by category - checkpoints, loras, vae, controlnet, upscale_models, embeddings
