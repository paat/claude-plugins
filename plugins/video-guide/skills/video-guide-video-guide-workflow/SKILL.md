...
This generated skill is the Codex-native plugin surface for `/video-guide:video-guide`.
Also use it when the user invokes `/video-guide` or asks for the same workflow by name.

Source command: `../../commands/video-guide.md`
...
- Plugin: `video-guide`
- Command aliases: `/video-guide:video-guide`, `/video-guide`
- Source description: Create a video guide with TTS narration and optional screen recording
