---
name: saas-startup-team-investigate-workflow
description: "Run /investigate workflow from saas-startup-team; alias /saas-startup-team:investigate."
---

# /saas-startup-team:investigate Codex Workflow

This generated skill is the Codex-native plugin surface for `/saas-startup-team:investigate`.
Also use it when the user invokes `/investigate` or asks for the same workflow by name.

Source command: `../../commands/investigate.md`
...
- Command aliases: `/saas-startup-team:investigate`, `/investigate`
- Source description: Investigate a live incident by correlation ID or recent sessions, create a redacted RCA artifact, and file or update a deduplicated GitHub issue when requested.
