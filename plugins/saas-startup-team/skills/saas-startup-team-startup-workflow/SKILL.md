...
This generated skill is the Codex-native plugin surface for `/saas-startup-team:startup`.
Also use it when the user invokes `/startup` or asks for the same workflow by name.

Source command: `../../commands/startup.md`
...
- Command aliases: `/saas-startup-team:startup`, `/startup`
- Source description: Initialize a new SaaS startup project - creates .startup/ directory, starts business-founder and tech-founder role phases, and kicks off the iterative build loop
