...
- Source description: Initialize a new SaaS startup project - creates .startup/ state, launches scoped founder role phases, and starts the iterative build loop
