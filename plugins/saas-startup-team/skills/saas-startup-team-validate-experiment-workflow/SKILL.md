---
name: saas-startup-team-validate-experiment-workflow
description: "Run /validate-experiment workflow from saas-startup-team; alias /saas-startup-team:validate-experiment."
---

# /saas-startup-team:validate-experiment Codex Workflow

This generated skill is the Codex-native plugin surface for `/saas-startup-team:validate-experiment`.
Also use it when the user invokes `/validate-experiment` or asks for the same workflow by name.

Source command: `../../commands/validate-experiment.md`
...
- Command aliases: `/saas-startup-team:validate-experiment`, `/validate-experiment`
- Source description: Run a demand-validation experiment from a plan file - build + deploy a fake-door waitlist landing page, optionally run a capped ad smoke-test, and collect MEASURED signals into a results file for the idea pipeline's confidence scoring. Usage: /validate-experiment <plan-file> [--collect]
