---
name: saas-startup-team-replay-abandoned-workflow
description: "Run /replay-abandoned workflow from saas-startup-team; alias /saas-startup-team:replay-abandoned."
---

# /saas-startup-team:replay-abandoned Codex Workflow

This generated skill is the Codex-native plugin surface for `/saas-startup-team:replay-abandoned`.
Also use it when the user invokes `/replay-abandoned` or asks for the same workflow by name.

Source command: `../../commands/replay-abandoned.md`
...
- Command aliases: `/saas-startup-team:replay-abandoned`, `/replay-abandoned`
- Source description: Replay abandoned funnel sessions against the configured funnel definition and emit structured findings for build-track follow-up.
