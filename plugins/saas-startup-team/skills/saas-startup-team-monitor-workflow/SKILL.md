---
name: saas-startup-team-monitor-workflow
description: "Run /monitor workflow from saas-startup-team; alias /saas-startup-team:monitor."
---

# /saas-startup-team:monitor Codex Workflow

This generated skill is the Codex-native plugin surface for `/saas-startup-team:monitor`.
Also use it when the user invokes `/monitor` or asks for the same workflow by name.

Source command: `../../commands/monitor.md`
...
- Command aliases: `/saas-startup-team:monitor`, `/monitor`
- Source description: On-demand post-launch monitor using the shared monitor and operate config blocks. Produces an interactive operations report without duplicating /monitor-nightly.
