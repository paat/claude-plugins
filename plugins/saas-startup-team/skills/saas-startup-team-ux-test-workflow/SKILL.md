...
This generated skill is the Codex-native plugin surface for `/saas-startup-team:ux-test`.
Also use it when the user invokes `/ux-test` or asks for the same workflow by name.

Source command: `../../commands/ux-test.md`
...
- Command aliases: `/saas-startup-team:ux-test`, `/ux-test`
- Source description: On-demand UX audit - evaluates usability, accessibility (WCAG 2.2 AA), visual consistency, and responsive design via Playwright browser testing. Usage: /ux-test <url>
