...
This generated skill is the Codex-native plugin surface for `/saas-startup-team:nudge`.
Also use it when the user invokes `/nudge` or asks for the same workflow by name.

Source command: `../../commands/nudge.md`
...
- Command aliases: `/saas-startup-team:nudge`, `/nudge`
- Source description: Unstick a deadlocked startup loop - manually send direction to a stuck founder or resolve a conflict between founders
