...
This generated skill is the Codex-native plugin surface for `/saas-startup-team:lawyer`.
Also use it when the user invokes `/lawyer` or asks for the same workflow by name.

Source command: `../../commands/lawyer.md`
...
- Command aliases: `/saas-startup-team:lawyer`, `/lawyer`
- Source description: On-demand legal analysis - queries the est-saas-datalake API and project context to produce Estonian-language legal compliance and risk analysis. Usage: /lawyer <topic>
