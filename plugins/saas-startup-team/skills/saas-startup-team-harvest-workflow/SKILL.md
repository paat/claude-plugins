...
This generated skill is the Codex-native plugin surface for `/saas-startup-team:harvest`.
Also use it when the user invokes `/harvest` or asks for the same workflow by name.

Source command: `../../commands/harvest.md`
