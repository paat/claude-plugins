...
This generated skill is the Codex-native plugin surface for `/saas-startup-team:bootstrap`.
Also use it when the user invokes `/bootstrap` or asks for the same workflow by name.

Source command: `../../commands/bootstrap.md`
...
- Command aliases: `/saas-startup-team:bootstrap`, `/bootstrap`
- Source description: Initialize project structure for the saas-startup-team plugin - creates docs/ and .startup/ directories, updates .gitignore and CLAUDE.md. Idempotent (safe to re-run).
