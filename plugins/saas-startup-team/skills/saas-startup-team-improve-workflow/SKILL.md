...
This generated skill is the Codex-native plugin surface for `/saas-startup-team:improve`.
Also use it when the user invokes `/improve` or asks for the same workflow by name.

Source command: `../../commands/improve.md`
...
- Command aliases: `/saas-startup-team:improve`, `/improve`
- Source description: One-shot founder/tech/QA improvement with a supervisor-gated commit. Usage: /improve [description]
