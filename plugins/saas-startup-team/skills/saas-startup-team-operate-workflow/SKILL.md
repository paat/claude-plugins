---
name: saas-startup-team-operate-workflow
description: "Run /operate workflow from saas-startup-team; alias /saas-startup-team:operate."
---

# /saas-startup-team:operate Codex Workflow

This generated skill is the Codex-native plugin surface for `/saas-startup-team:operate`.
Also use it when the user invokes `/operate` or asks for the same workflow by name.

Source command: `../../commands/operate.md`
...
- Command aliases: `/saas-startup-team:operate`, `/operate`
- Source description: Post-launch operations entry point. Routes live-product monitoring, incident investigation, abandoned-session replay, and support triage from the shared operate config block.
