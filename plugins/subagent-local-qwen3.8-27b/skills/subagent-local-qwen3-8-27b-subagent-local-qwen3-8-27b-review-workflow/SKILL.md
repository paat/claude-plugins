---
name: subagent-local-qwen3-8-27b-subagent-local-qwen3-8-27b-review-workflow
description: "Run /subagent-local-qwen3-8-27b-review workflow from subagent-local-qwen3.8-27b; alias /subagent-local-qwen3.8-27b:subagent-local-qwen3-8-27b-review."
---

# /subagent-local-qwen3.8-27b:subagent-local-qwen3-8-27b-review Codex Workflow

This generated skill is the Codex-native plugin surface for `/subagent-local-qwen3.8-27b:subagent-local-qwen3-8-27b-review`.
Also use it when the user invokes `/subagent-local-qwen3-8-27b-review` or asks for the same workflow by name.

Source command: `../../commands/subagent-local-qwen3.8-27b-review.md`
...
- Command aliases: `/subagent-local-qwen3.8-27b:subagent-local-qwen3-8-27b-review`, `/subagent-local-qwen3-8-27b-review`
- Source description: Independent read-only review via local llama.cpp Qwen3.8-27B (Qwen Code CLI, approval-mode plan)
