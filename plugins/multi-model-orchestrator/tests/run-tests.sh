...
contains "$META_SKILL" 'write the final handoff and commit it on the epic branch, path-limited' 'Meta skill commits the final handoff only at strategy A close-out'
contains "$META_SKILL" 'commit it on the epic branch' 'Meta skill commits the final handoff on the epic branch'
contains "$META_SKILL" 'without `--delete-branch`' 'Meta skill keeps the epic branch for the close-out handoff commit'
...
contains "$META_SKILL" 'git add -f <handoff>' 'Meta skill force-stages the excluded handoff before the path-limited commit'
