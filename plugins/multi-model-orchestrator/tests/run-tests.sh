...
contains "$META_SKILL" 'Once the queue is ordered' 'Meta skill writes the handoff once the queue is ordered'
contains "$META_SKILL" 'path-limited commit on the epic branch' 'Meta skill commits handoffs on the epic branch in strategy A'
contains "$META_SKILL" '.git/info/exclude' 'Meta skill excludes the handoff dir in strategy B'
contains "$META_SKILL" 'Strategy B: never commit it' 'Meta skill never commits handoffs in strategy B'
...
contains "$META_SKILL" 'announcing a dispatch without that written handoff (committed in strategy A) is a defect' 'Meta skill forbids announced dispatches without the written handoff'
