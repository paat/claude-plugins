...
contains "$META_SKILL" 'Genuine judgment calls are decided with the recommended default and recorded' 'Meta skill decides judgment calls instead of parking them'
