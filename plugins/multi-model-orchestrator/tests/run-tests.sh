...
contains "$META_SKILL" 'Stop only for credentials, browser authentication, repo-policy changes,' 'Meta skill names the closed escalation set (credentials through policy)'
