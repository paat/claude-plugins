...
/// <summary>SEEDED TRAP: required-claim guard deleted — a missing merchantReference now reaches the
/// store lookup (TryGetValue(null)) and errors instead of returning 400.</summary>
public sealed class Trap02MissingClaimGuard : IPaymentHandler
{
