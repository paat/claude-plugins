...
This generated skill is the Codex-native plugin surface for `/analyst-companion:meeting-end`.
Also use it when the user invokes `/meeting-end` or asks for the same workflow by name.

Source command: `../../commands/meeting-end.md`
...
- Plugin: `analyst-companion`
- Command aliases: `/analyst-companion:meeting-end`, `/meeting-end`
- Source description: End the meeting - stop the loop, mark the session ended, synthesize proposed Plane work items from the full transcript, confirm scope, then create them in Plane.
