...
This generated skill is the Codex-native plugin surface for `/analyst-companion:meeting-start`.
Also use it when the user invokes `/meeting-start` or asks for the same workflow by name.

Source command: `../../commands/meeting-start.md`
...
- Command aliases: `/analyst-companion:meeting-start`, `/meeting-start`
- Source description: Start a live meeting analyst session - mints an aimeet session, prints the console URL to open on the laptop, and starts the companion loop.
