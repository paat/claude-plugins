...
This generated skill is the Codex-native plugin surface for `/gemini-cli:gemini-second-opinion`.
Also use it when the user invokes `/gemini-second-opinion` or asks for the same workflow by name.

Source command: `../../commands/gemini-second-opinion.md`
...
- Plugin: `gemini-cli`
- Command aliases: `/gemini-cli:gemini-second-opinion`, `/gemini-second-opinion`
- Source description: Get Gemini's second opinion on an approach or decision
