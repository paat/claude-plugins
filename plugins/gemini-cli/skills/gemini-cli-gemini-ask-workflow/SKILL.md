...
This generated skill is the Codex-native plugin surface for `/gemini-cli:gemini-ask`.
Also use it when the user invokes `/gemini-ask` or asks for the same workflow by name.

Source command: `../../commands/gemini-ask.md`
...
- Plugin: `gemini-cli`
- Command aliases: `/gemini-cli:gemini-ask`, `/gemini-ask`
- Source description: Ask Gemini a question and get a response
