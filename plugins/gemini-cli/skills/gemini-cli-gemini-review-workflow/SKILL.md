...
This generated skill is the Codex-native plugin surface for `/gemini-cli:gemini-review`.
Also use it when the user invokes `/gemini-review` or asks for the same workflow by name.

Source command: `../../commands/gemini-review.md`
...
- Plugin: `gemini-cli`
- Command aliases: `/gemini-cli:gemini-review`, `/gemini-review`
- Source description: Get a dual AI code review - Gemini + the current Codex agent analyze code together
