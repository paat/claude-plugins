...
This generated skill is the Codex-native plugin surface for `/silent-failure-scanner:scan`.
Also use it when the user invokes that command or asks for the same workflow by name.

Source command: `../../commands/scan.md`
...
- Plugin: `silent-failure-scanner`
- Command aliases: `/silent-failure-scanner:scan`
- Source description: Scan a git diff for silent-failure signatures (swallowed errors, ghost transactions)
