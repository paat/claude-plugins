...
This generated skill is the Codex-native plugin surface for `/i18n-parity:i18n-parity`.
Also use it when the user invokes `/i18n-parity` or asks for the same workflow by name.
...
- Plugin: `i18n-parity`
- Command aliases: `/i18n-parity:i18n-parity`, `/i18n-parity`
- Source description: Run the translation key-parity gate, or bootstrap its config by inspecting the repo
