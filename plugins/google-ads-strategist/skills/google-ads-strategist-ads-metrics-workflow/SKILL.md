...
This generated skill is the Codex-native plugin surface for `/google-ads-strategist:ads-metrics`.
Also use it when the user invokes `/ads-metrics` or asks for the same workflow by name.

Source command: `../../commands/ads-metrics.md`
