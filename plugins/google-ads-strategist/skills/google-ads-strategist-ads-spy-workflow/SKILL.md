...
This generated skill is the Codex-native plugin surface for `/google-ads-strategist:ads-spy`.
Also use it when the user invokes `/ads-spy` or asks for the same workflow by name.

Source command: `../../commands/ads-spy.md`
...
- Command aliases: `/google-ads-strategist:ads-spy`, `/ads-spy`
- Source description: Pull all currently-running ads for a competitor from the Google Ads Transparency Center. Produces a structured competitor matrix for copy differentiation. Delegates to ads-strategist. Usage: /ads-spy <competitor-domain-or-name> [--country X]
