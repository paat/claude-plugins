...
This generated skill is the Codex-native plugin surface for `/google-ads-strategist:ads-ready`.
Also use it when the user invokes `/ads-ready` or asks for the same workflow by name.

Source command: `../../commands/ads-ready.md`
...
- Command aliases: `/google-ads-strategist:ads-ready`, `/ads-ready`
- Source description: Audit the current iteration against the launch-readiness checklist. Does NOT launch - only reports pass/fail per condition, with evidence links. Usage: /ads-ready [campaign]
