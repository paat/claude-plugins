...
This generated skill is the Codex-native plugin surface for `/google-ads-strategist:ads-verify`.
Also use it when the user invokes `/ads-verify` or asks for the same workflow by name.

Source command: `../../commands/ads-verify.md`
...
- Command aliases: `/google-ads-strategist:ads-verify`, `/ads-verify`
- Source description: Quick one-shot verification of a single keyword or the current iteration via the Anonymous Ad Preview Tool. Captures screenshot + structured result. Usage: /ads-verify [campaign] [keyword] [--location X] [--device mobile|desktop]
