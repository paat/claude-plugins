...
This generated skill is the Codex-native plugin surface for `/google-ads-strategist:ads-hypothesize`.
Also use it when the user invokes `/ads-hypothesize` or asks for the same workflow by name.

Source command: `../../commands/ads-hypothesize.md`
...
- Command aliases: `/google-ads-strategist:ads-hypothesize`, `/ads-hypothesize`
- Source description: Given the current state of a campaign (pre-launch or post-launch), propose a ranked list of candidate hypotheses for the next iteration - expected impact x confidence. Does NOT write the hypothesis, only suggests. Usage: /ads-hypothesize [campaign]
