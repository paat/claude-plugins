...
This generated skill is the Codex-native plugin surface for `/google-ads-strategist:ads-create`.
Also use it when the user invokes `/ads-create` or asks for the same workflow by name.

Source command: `../../commands/ads-create.md`
...
- Command aliases: `/google-ads-strategist:ads-create`, `/ads-create`
- Source description: Create the v1 campaign in Google Ads via Chrome automation. Reads spec.md, builds the campaign in the Ads UI step by step, and saves it in PAUSED state for investor review. The investor enables the campaign after reviewing it in the Ads UI. Usage: /ads-create [campaign]
