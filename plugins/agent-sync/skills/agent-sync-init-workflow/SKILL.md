...
This generated skill is the Codex-native plugin surface for `/agent-sync:init`.
Also use it when the user invokes that command or asks for the same workflow by name.

Source command: `../../commands/init.md`
...
- Plugin: `agent-sync`
- Command aliases: `/agent-sync:init`
- Source description: Scaffold sources.json by scanning existing Claude Code configuration
