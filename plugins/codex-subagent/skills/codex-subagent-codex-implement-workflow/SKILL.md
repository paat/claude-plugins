...
This generated skill is the Codex-native plugin surface for `/codex-subagent:codex-implement`.
Also use it when the user invokes `/codex-implement` or asks for the same workflow by name.

Source command: `../../commands/codex-implement.md`
...
- Command aliases: `/codex-subagent:codex-implement`, `/codex-implement`
- Source description: Dispatch OpenAI Codex CLI as the implementer for ONE named task from a plan file
