...
This generated skill is the Codex-native plugin surface for `/browser-test-router:browser-test`.
Also use it when the user invokes that command or asks for the same workflow by name.

Source command: `../../commands/browser-test.md`
...
- Plugin: `browser-test-router`
- Command aliases: `/browser-test-router:browser-test`
- Source description: Run browser testing with multi-model delegation for token efficiency
